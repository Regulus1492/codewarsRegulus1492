...
def likes(names):
    if not names:
        text_print = "no one likes this"
    else:
        if len(names) == 1:
            text_print = f"{names[0]} likes this"
        elif len(names) == 2:
            text_print = " and ".join(names) + " like this"
        elif len(names) == 3:
            text_print = f"{names[0]}, {names[1]} and {names[2]} like this"
        else:
            text_print = f"{names[0]}, {names[1]} and {len(names) - 2} others like this"
